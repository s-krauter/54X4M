...
class Music(commands.Cog):
    ...
    def play_next(self):
        if len(self.music_queue) > 0:
            ...
            self.vc.play(discord.FFmpegPCMAudio(executable="C:\ffmpeg\bin\ffmpeg", source = m_url, **self.FFMPEG_OPTIONS), after=lambda e: self.play_next())
        else:
            self.is_playing = False
...
#music cog ripped straight from:
